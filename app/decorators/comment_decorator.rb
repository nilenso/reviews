class CommentDecorator < Draper::Decorator
  ...
  def render_with_children(commentable, all_comments)
    ...
    buttons = [h.link_to("Reply", h.new_comment_path(commentable_id: commentable.id, commentable_type: commentable_type(commentable), parent_id: model.id), class: "comment-button btn btn-dark btn-xs"),
               h.link_to("Edit", h.edit_comment_path(model, commentable_id: commentable.id, commentable_type: commentable_type(commentable)), class: "comment-button btn btn-dark btn-xs"),
               h.link_to("Delete", h.comment_path(model, commentable_id: commentable.id, commentable_type: commentable_type(commentable)), method: :delete, data: {confirm: "Sure?"}, class: "comment-button btn btn-dark btn-xs")].join
